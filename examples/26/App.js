...
export class App extends ZuiElement {
  ...
  zuiCreateHTMLElements(shadowRoot) {
    ...
    this.zuiSet(e2, "min",  f6());
    const f7 = (() => ("10")).bind(this);
    this.zuiSet(e2, "max",  f7());
    const f8 = f4;
    this.zuiSet(e2, "value",  f8());
    this.zuiSub('a', () => this.zuiSet(e2, "value",  f8()));
    ...
    this.zuiSet(e10, "type",  f11());
    const f12 = f4;
    const f13 = ((evt) => { this.#a = parseInt(e10.value); }).bind(this);
    e10.addEventListener('input', f13);
    e10.addEventListener('change', f13);
    const f14 = f6;
    this.zuiSet(e10, "min",  f14());
    const f15 = f7;
    this.zuiSet(e10, "max",  f15());
    const f16 = f4;
    this.zuiSet(e10, "value",  f16());
    this.zuiSub('a', () => this.zuiSet(e10, "value",  f16()));
    ...
    const f23 = f6;
    this.zuiSet(e19, "min",  f23());
    const f24 = f7;
    this.zuiSet(e19, "max",  f24());
    const f25 = f21;
    this.zuiSet(e19, "value",  f25());
    this.zuiSub('b', () => this.zuiSet(e19, "value",  f25()));
    ...
    const n_e27 = [];
    const f28 = f11;
    this.zuiSet(e27, "type",  f28());
    const f29 = f21;
    const f30 = ((evt) => { this.#b = parseInt(e27.value); }).bind(this);
    e27.addEventListener('input', f30);
    e27.addEventListener('change', f30);
    const f31 = f6;
    this.zuiSet(e27, "min",  f31());
    const f32 = f7;
    this.zuiSet(e27, "max",  f32());
    const f33 = f21;
    this.zuiSet(e27, "value",  f33());
    this.zuiSub('b', () => this.zuiSet(e27, "value",  f33()));
    ...
    const f36 = f4;
    const e37 = newT(f36());
    this.zuiSub('a', (() => { e37.nodeValue = f36(); }));
    n_e35.push(e37);
    n_e35.push(newT(" + "));
    const f38 = f21;
    const e39 = newT(f38());
    this.zuiSub('b', (() => { e39.nodeValue = f38(); }));
    n_e35.push(e39);
    n_e35.push(newT(" = "));
    const f40 = (() => (this.#a + this.#b)).bind(this);
    const e41 = newT(f40());
    this.zuiSub('a', (() => { e41.nodeValue = f40(); }));
    this.zuiSub('b', (() => { e41.nodeValue = f40(); }));
    n_e35.push(e41);
